...
{-# LINE 2 "Codec/Compression/BZip/Stream.hsc" #-}
-----------------------------------------------------------------------------
-- |
...
{-# LINE 68 "Codec/Compression/BZip/Stream.hsc" #-}
...
run (BZ m) = unsafePerformIO $ do
  ptr <- mallocBytes (48)
{-# LINE 258 "Codec/Compression/BZip/Stream.hsc" #-}
  (\hsc_ptr -> pokeByteOff hsc_ptr 36)   ptr nullPtr
{-# LINE 259 "Codec/Compression/BZip/Stream.hsc" #-}
  (\hsc_ptr -> pokeByteOff hsc_ptr 40)    ptr nullPtr
{-# LINE 260 "Codec/Compression/BZip/Stream.hsc" #-}
  (\hsc_ptr -> pokeByteOff hsc_ptr 44)    ptr nullPtr
{-# LINE 261 "Codec/Compression/BZip/Stream.hsc" #-}
  (\hsc_ptr -> pokeByteOff hsc_ptr 0)   ptr nullPtr
{-# LINE 262 "Codec/Compression/BZip/Stream.hsc" #-}
  (\hsc_ptr -> pokeByteOff hsc_ptr 16)  ptr nullPtr
{-# LINE 263 "Codec/Compression/BZip/Stream.hsc" #-}
  (\hsc_ptr -> pokeByteOff hsc_ptr 4)  ptr (0 :: CUInt)
{-# LINE 264 "Codec/Compression/BZip/Stream.hsc" #-}
  (\hsc_ptr -> pokeByteOff hsc_ptr 20) ptr (0 :: CUInt)
{-# LINE 265 "Codec/Compression/BZip/Stream.hsc" #-}
...
toStatus (0)         = Ok
{-# LINE 373 "Codec/Compression/BZip/Stream.hsc" #-}
toStatus (1)     = Ok
{-# LINE 374 "Codec/Compression/BZip/Stream.hsc" #-}
toStatus (2)   = Ok
{-# LINE 375 "Codec/Compression/BZip/Stream.hsc" #-}
toStatus (3)  = Ok
{-# LINE 376 "Codec/Compression/BZip/Stream.hsc" #-}
toStatus (4) = StreamEnd
{-# LINE 377 "Codec/Compression/BZip/Stream.hsc" #-}
...
{-# LINE 387 "Codec/Compression/BZip/Stream.hsc" #-}
 -2      -> "incorrect parameter"
{-# LINE 388 "Codec/Compression/BZip/Stream.hsc" #-}
 -3        -> "not enough memory"
{-# LINE 389 "Codec/Compression/BZip/Stream.hsc" #-}
 -4       -> "compressed data stream is corrupt"
{-# LINE 390 "Codec/Compression/BZip/Stream.hsc" #-}
 -5 -> "data stream is not a bzip2 file"
{-# LINE 391 "Codec/Compression/BZip/Stream.hsc" #-}
 -9     -> "configuration error in bzip2 lib"
{-# LINE 392 "Codec/Compression/BZip/Stream.hsc" #-}
...
fromAction Run    = 0
{-# LINE 402 "Codec/Compression/BZip/Stream.hsc" #-}
fromAction Flush  = 1
{-# LINE 403 "Codec/Compression/BZip/Stream.hsc" #-}
fromAction Finish = 2
{-# LINE 404 "Codec/Compression/BZip/Stream.hsc" #-}
